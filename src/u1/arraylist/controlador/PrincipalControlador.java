...
public class PrincipalControlador {
    ...
    public void agregarEstudiante() {
        ...
        int codigo = Integer.parseInt(frame.getTxtCodigo().getText());
    ...
    public void cargarDatosEstudiante() {
        ...
        if (!lineaEstudiante.isBlank()) {
            ...
            if (!codigo.isBlank()) {
                Estudiante e = negocio.buscarEstudiante(Integer.parseInt(codigo));
                if (e != null) {
                    ...
                    frame.getTxtVerCodigo().setText(String.valueOf(e.getCodigo()));
                }
            }
        }
    }
    ...
    public void guardarActualizacion() {
        ...
        int codigo = Integer.parseInt(frame.getTxtVerCodigo().getText());

        negocio.actualizarInfo(nombre, apellido, edad, promedio, codigo);
